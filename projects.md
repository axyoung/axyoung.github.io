...
Despite this being a group project, I did a large portion of the work in both understanding the algorithm and coding it.
...
In order to program the ATmega 128 board I used AVR assembly code to solve these various math equation.
